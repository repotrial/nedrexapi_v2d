...
_NETWORK_CACHE_SUFFIX = "network_cache_"
...
_TRUSTRANK_DIR_INTERNAL = _DATA_DIR_INTERNAL / _TRUSTRANK_SUFFIX
_NETWORK_CACHE_DIR = _DATA_DIR_INTERNAL / _NETWORK_CACHE_SUFFIX
